...
public class Spider extends HEntity {
    ...
    public Spider() {
        super("@lang/main.entity_spider/", EntityType.SPIDER, 100, TargetType.PLAYERS);
    }

    @Override
    public Entity spawn(Location location) {
        Level level = ((CraftWorld)location.getWorld()).getHandle();
        Entity entity = new Spider.EntitySpider(level);;
    ...
    class EntitySpider extends net.minecraft.world.entity.monster.Spider {

        public EntitySpider(Level world) {
            super(net.minecraft.world.entity.EntityType.SPIDER, world);
        }
